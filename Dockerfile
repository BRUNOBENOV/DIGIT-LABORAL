...
CMD ["sh", "-c", "python -m app.admin_recovery && python -m app.dashboard_smoke && uvicorn app.runtime:app --host 0.0.0.0 --port ${PORT:-8000} --proxy-headers --forwarded-allow-ips='*'"]
