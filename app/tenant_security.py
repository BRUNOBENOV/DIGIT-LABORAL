...
def rls_production_note() -> str:
    return (
        "RLS está diseñado para ejecutarse con un usuario PostgreSQL de aplicación que no sea propietario "
        "de las tablas ni tenga BYPASSRLS. El usuario de migración puede conservar permisos superiores."
    )
